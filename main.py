...
bot = telebot.TeleBot(token='1490311411:AAE8VLz-LeOEYZXb1j8cokvjkX8-7BAtMwo', parse_mode='Markdown')
...
if __name__=='__main__':
    feedback_chat = '1450222755' #Insira um Chat ID pra receber os "excepts" do bot, e monitora-lo. pode ser seu proprio, ou de um grupo.
    while True:
        try:
